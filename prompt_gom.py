...
def build_purpose_prompt(summaries, example=None):
    ...
    base = (
        ...
        "You are reviewing an Excel model based on the **Gompertz-Markeham mortality framework**.\n\n"
...
def build_input_prompt(input_name, summary_json, hint_sentence=None, example=None):
    base = (
        ...
        "You are reviewing a spreadsheet model based on the Gompertz-Markeham mortality framework or a closely related framework.\n\n"
...
def build_output_prompt(output_name, summary_json, hint_sentence=None, example=None):
    base = (
        "You are an expert actuary and spreadsheet modeller.\n\n"
        "You are reviewing an Excel spreadsheet built on the **Gompertz-Markeham mortality framework** or a closely related survival modelling framework.\n\n"
...
def build_logic_prompt(name, summary_json, step_number, hint_sentence=None, example=None):
    base = (
        "You are an expert actuary and spreadsheet modeller.\n\n"
        "You are reviewing a **logic step** in an Excel model built on the **Gompertz-Markeham mortality framework** or a similar survival projection framework.\n\n"
        f"{hint_sentence or ''}\n\n"
...
def build_check_prompt(name, summary_json, hint_sentence=None, example=None):
    base = (
        "You are an expert actuary and spreadsheet modeller.\n\n"
        "You are reviewing a **validation check** in an Excel model based on the **Gompertz-Markeham mortality framework** or a similar survival model.\n\n"
        f"{hint_sentence or ''}\n\n"
...
def build_assumptions_prompt(summaries, example=None):
    ...
    base = (
        "You are an expert actuary and spreadsheet modeller reviewing a workbook based on the **Gompertz-Markeham mortality framework** "
